 ...
 * generated in the autorizacion.ws.sri.gob.ec package.
...
public class ObjectFactory {
    ...
    private final static QName _RespuestaAutorizacion_QNAME =
        new QName("http://ec.gob.sri.ws.autorizacion", "RespuestaAutorizacion");
    private final static QName _Autorizacion_QNAME = new QName("http://ec.gob.sri.ws.autorizacion", "autorizacion");
    private final static QName _AutorizacionComprobante_QNAME =
        new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobante");
    private final static QName _AutorizacionComprobanteLote_QNAME =
        new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobanteLote");
    private final static QName _AutorizacionComprobanteLoteResponse_QNAME =
        new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobanteLoteResponse");
    private final static QName _AutorizacionComprobanteResponse_QNAME =
        new QName("http://ec.gob.sri.ws.autorizacion", "autorizacionComprobanteResponse");
    private final static QName _Mensaje_QNAME = new QName("http://ec.gob.sri.ws.autorizacion", "mensaje");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: autorizacion.ws.sri.gob.ec
     *
     */
    ...
    public JAXBElement<AutorizacionComprobante> createAutorizacionComprobante(AutorizacionComprobante value) {
        return new JAXBElement<AutorizacionComprobante>(_AutorizacionComprobante_QNAME, AutorizacionComprobante.class,
                                                        null, value);
    }
    ...
    public JAXBElement<AutorizacionComprobanteLote> createAutorizacionComprobanteLote(AutorizacionComprobanteLote value) {
        return new JAXBElement<AutorizacionComprobanteLote>(_AutorizacionComprobanteLote_QNAME,
    ...
    public JAXBElement<AutorizacionComprobanteLoteResponse> createAutorizacionComprobanteLoteResponse(AutorizacionComprobanteLoteResponse value) {
        return new JAXBElement<AutorizacionComprobanteLoteResponse>(_AutorizacionComprobanteLoteResponse_QNAME,
                                                                    AutorizacionComprobanteLoteResponse.class, null,
                                                                    value);
    }
    ...
    public JAXBElement<AutorizacionComprobanteResponse> createAutorizacionComprobanteResponse(AutorizacionComprobanteResponse value) {
        return new JAXBElement<AutorizacionComprobanteResponse>(_AutorizacionComprobanteResponse_QNAME,
