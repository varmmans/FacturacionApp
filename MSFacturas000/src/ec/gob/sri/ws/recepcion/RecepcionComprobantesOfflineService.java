 ...
 *
 */
@WebServiceClient(name = "RecepcionComprobantesOfflineService", targetNamespace = "http://ec.gob.sri.ws.recepcion",
                  wsdlLocation =
                  "https://celcer.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantesOffline?wsdl#%7Bhttp%3A%2F%2Fec.gob.sri.ws.recepcion%7DRecepcionComprobantesOfflineService")
public class RecepcionComprobantesOfflineService extends Service {
    ...
    private final static QName RECEPCIONCOMPROBANTESOFFLINESERVICE_QNAME =
    ...
    static {
        ...
        try {
            url =
                new URL("https://celcer.sri.gob.ec/comprobantes-electronicos-ws/RecepcionComprobantesOffline?wsdl#%7Bhttp%3A%2F%2Fec.gob.sri.ws.recepcion%7DRecepcionComprobantesOfflineService");
    ...
    public RecepcionComprobantesOffline getRecepcionComprobantesOfflinePort() {
        return super.getPort(new QName("http://ec.gob.sri.ws.recepcion", "RecepcionComprobantesOfflinePort"),
