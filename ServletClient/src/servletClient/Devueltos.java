...
@WebServlet(name = "devueltos", urlPatterns = { "devueltos" })
public class Devueltos extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head><title>Comprobantes Devueltos</title>");
        ...
        try {
            out.println("<h3>Comprobantes Devueltos</h3>");
            printDocumento(out, facturaEJBBean.getDocumentoFindxStatus(ComprobanteEnum.DEVUELTO.getValue()));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
