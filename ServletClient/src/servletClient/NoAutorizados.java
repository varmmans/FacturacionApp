...
@WebServlet(name = "no-autorizados", urlPatterns = { "no-autorizados" })
public class NoAutorizados extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head><title>Comprobantes No Autorizados</title>");
        ...
        try {
            out.println("<h3>Comprobantes No Autorizados</h3>");
            printDocumento(out, facturaEJBBean.getDocumentoFindxStatus(ComprobanteEnum.NO_AUTORIZADO.getValue()));
        } catch (Exception ex) {
            ex.printStackTrace();
