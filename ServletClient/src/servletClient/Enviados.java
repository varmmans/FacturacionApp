...
@WebServlet(name = "enviados", urlPatterns = { "enviados" })
public class Enviados extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<html>");
        out.println("<head><title>Comprobantes Enviados</title>");
        ...
        try {
            facturaEJBBean.flowComprobantes();
            out.println("<h3>Comprobantes Enviados</h3>");
            List<Documento> docs = facturaEJBBean.getDocumentoFindxStatus(ComprobanteEnum.ENVIADO.getValue());
            printDocumento(out, docs);
        } catch (Exception ex) {
            ex.printStackTrace();
        }
